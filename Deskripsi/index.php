...
<body>
    <h1><blockquote><?= "Keamanan Data Deskripsi"?></blockquote></h1>
...
<br> <i>Deskripsi : proses mengubah data yang telah dibuat tidak dapat dibaca 
    melalui deskripsi kembali.</i></p><br>
    <h4>
        <blockquote>
            <?php echo " Deskripsi dengan Aes-256-cbc<br>";
